...
// Geralmente essa variável fica no .env
export const JWT_SECRET = "supersecret";

export const ADMIN_SUPER_SECRET = "admin_supersecret";

// Ideal armazenar tokens de serviço no DB
...
export function initAuthRoute(fastify) {
  fastify.addHook("onRequest", async (request, reply) => {
    ...
    // Duas formas de autenticação diferentes
    if (serviceUser) {
