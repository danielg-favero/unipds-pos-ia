...
export const server = new McpServer({
  name: "@danielg.favero/ciphersuite-mcp",
  version: "0.0.1",
});
...
server.registerTool(
  ...
  {
    description:
      "Decrypt message that was encrypted with the encrypt_message tool",
    inputSchema: {
      encryptedMessage: z
        .string()
        .describe("The encrypted message (format: iv:ciphertext)"),
...
// Resources são como documentos que o MCP server disponibiliza para o LLM ler.
server.registerResource(
  "encryption://info" /* Nome que será exibido */,
  "encryption://info" /* Nome da URI */,
  {
    description:
