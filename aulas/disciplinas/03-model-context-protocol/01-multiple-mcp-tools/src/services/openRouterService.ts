...
export class OpenRouterService {
  ...
  async generateStructured<T>(
    ...
    // A LLM pode retornar resultados estruturados como JSON usando o schema (o providerStrategy sobrescreve todas as tools) ou ele pode chamar uma lista de tools e retornar o dado em forma de texto
